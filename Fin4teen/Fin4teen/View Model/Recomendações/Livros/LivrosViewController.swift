...
class LivrosViewController: UIViewController {
    ...
    @IBOutlet weak var myProgramasCollectionViewCell: UICollectionView!
...
class ProgramasTvViewController: UIViewController {
    ...
    extension ProgramasTvViewController: UICollectionViewDelegate, UICollectionViewDataSource {
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            let cell = myProgramasCollectionViewCell.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! ProgramasTVCollectionViewCell
